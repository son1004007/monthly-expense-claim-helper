...
| PJT 코드 | `#dynamic_table1_{row}_4` | `BDB25-10043` | 프로젝트 코드 매핑 필요 |
...
| 상세내역 | `#dynamic_table1_{row}_8` | `숙대입구역-공항화물청사역` | 교통 구간 또는 결제 시각 |
...
```json
{
  ...
  "target": "손기석",
  "project_alias": "인천공항_데이터 분석서비스",
  "project_code": "BDB25-10043",
  "account_group": "판관비",
  "account_subject": "여비교통비",
  "account_item": "업무교통비",
  "amount": 4450,
  "detail": "숙대입구역-공항화물청사역",
...
```json
{
  ...
  "expense_date": "2026-06-25",
  "target": "손기석",
  "project_alias": "한국지역난방공사",
  "project_code": "BDB26-10047",
  "account_group": "판관비",
...
4. 교통사용 내역 `.xls` 파서 구현
5. `야근식대.txt` 파서 구현
6. `claim-preview.md` 생성기 구현
7. 전자결재 화면 필드 검증 스크립트 구현
8. dry-run 입력 계획 출력 구현
9. Chrome/Playwright 자동 입력 구현
10. 첨부파일 업로드 확인 절차 구현
